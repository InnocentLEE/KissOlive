...
public class UserServlet extends BaseServlet {
	...
	public String regist(HttpServletRequest req, HttpServletResponse resp)
		...
		Map<String,String> errors = validateRegist(usertel, password,password2,province, city, district, detail,name, tel, verifyCode, req.getSession());
		if(errors.size()>0){
		...
		Address address =  new Address(CommonUtils.uuid(), user, province, 1, city, district, detail, name, tel);
	 ...
	 * @return
	 */
	public Map<String, String> validateRegist(String usertel, String password,String password2,
			String province, String city, String district, String detail,
			String name, String tel, String verifyCode, HttpSession session) {
