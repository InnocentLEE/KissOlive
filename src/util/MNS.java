...
public class MNS {
	...
	public static SendSmsResponse sendSms(String telphone, String VerifyCode)
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("KissOlive商城");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_129761590");
	...
	/*
	 * public static void main(String[] args) { try { MNS.sendSms("13129729858",
	 * "1234"); } catch (ClientException e) { throw new RuntimeException(); } }
	 */
	public static void main(String[] args) {
		System.out.println(MNS.getVerifyCode());
	}
}
